...
const AllAnswers = async({questionId, userId, totalAnswers, page, filter}:Props) => {
  ...
  return (
    <div className=' mt-11'>
        ...
        <div>
            {(await result.answers).map((answer:any)=>(
                    ...
                    <div className='flex items-center justify-between'>
                        <div className='mb-8 flex flex-col-reverse justify-between gap-5 sm:flex-row sm:items-center sm:gap-2'>
                            ...
                            <Votes
                                ...
                                hasupVoted={answer.upvotes ? answer.upvotes.includes(userId) : false}
                                downvotes={answer.downvotes?.length || 0}
                                hasdownVoted={answer.downvotes ? answer.downvotes.includes(userId) : false}
                            />
                            </div>
                        </div>
                    </div>
